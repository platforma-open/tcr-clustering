...
import { platforma } from "@platforma-open/milaboratories.tcr-clustering.model";
import {
  InferOutputsType,
  InferDataType,
  InferHrefType,
...
export type TcrClusteringBlockContract = BlockContract;
export type TcrClusteringBlockOutputs  = BlockOutputs;
export type TcrClusteringBlockData     = BlockData;
export const TcrClusteringBlockPointer = BlockPointer;
